...
// Mom manages model/provider config through its own config.ts / settings.json.
...
export function createMomSettingsManager(_workspaceDir: string): SettingsManager {
